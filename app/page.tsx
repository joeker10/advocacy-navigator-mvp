...
import { MeetingPrepChecklist } from "@/components/MeetingPrepChecklist";
...
export default function Home() {
  ...
  const isNativePlatform = typeof window !== "undefined" && Boolean(
    (window as any).Capacitor?.isNativePlatform?.() || 
    window.location.href.startsWith("file:") ||
    (window.location.hostname === "localhost" && window.location.port === "")
  );
  const API_URL = isNativePlatform ? "https://www.thespecialeducationnavigator.app" : "";
          ...
          {showVerificationInput ? (
            ...
            <form onSubmit={handleAuthSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", width: "100%", alignItems: "center" }}>
                <div id="google-signin-btn-web" style={{ width: "100%", display: isNativePlatform ? "none" : "flex", justifyContent: "center" }}></div>
                {isNativePlatform && (
                  <button
                    type="button"
    ...
    <ErrorBoundary>
        ...
        <div className="container" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", height: "72px" }}>
          <div className="nav-logo-group" style={{ display: "flex", alignItems: "center", gap: "24px" }}>
            ...
            <div style={{ display: "flex", gap: "16px", marginLeft: "12px", alignItems: "center" }} role="navigation" aria-label="Public Pages Menu" className="desktop-nav">
              ...
              <a href="/posts" onClick={(e) => handleLinkClick(e, "/posts")} style={{ color: "var(--foreground)", opacity: 0.8, textDecoration: "none", fontSize: "0.9rem", fontWeight: 500, transition: "opacity 0.2s" }} onMouseOver={(e) => e.currentTarget.style.opacity = "1"} onMouseOut={(e) => e.currentTarget.style.opacity = "0.8"}>
                Articles
              </a>
              <a href="/downloads" onClick={(e) => handleLinkClick(e, "/downloads")} style={{ color: "var(--foreground)", opacity: 0.8, textDecoration: "none", fontSize: "0.9rem", fontWeight: 500, transition: "opacity 0.2s" }} onMouseOver={(e) => e.currentTarget.style.opacity = "1"} onMouseOut={(e) => e.currentTarget.style.opacity = "0.8"}>
                Downloads
              </a>
          ...
          <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
            <button 
              ...
              style={{
                padding: "8px 12px", borderRadius: "20px", display: "flex", gap: "5px", alignItems: "center",
                background: "rgba(255, 255, 255, 0.05)", border: "1px solid var(--glass-border)", color: "var(--foreground)",
                cursor: "pointer", fontWeight: 600, fontSize: "0.82rem",
                boxShadow: "var(--shadow-sm)"
              }}
              title="IEP Meeting Prep Strategy Checklist"
            >
              📋 <span className="button-text">Prep</span>
            </button>
            ...
            <button 
              ...
              title="Special Education & Hawaii Chapter 60 Acronym Glossary"
            >
      ...
      {isMobileMenuOpen && (
        <div style={{
          ...
          <button
            type="button"
            onClick={() => { setIsMobileMenuOpen(false); setShowTimelineModal(true); }}
            style={{ fontSize: "1rem", fontWeight: 600, padding: "0.5rem 0", borderBottom: "1px solid var(--glass-border)", color: "var(--foreground)", display: "flex", alignItems: "center", gap: "8px", background: "none", border: "none", width: "100%", textAlign: "left", cursor: "pointer" }}
          >
            ⏱️ IEP Milestone Timeline
          </button>
          <button
            type="button"
            onClick={() => { setIsMobileMenuOpen(false); setShowGlossaryModal(true); }}
            style={{ fontSize: "1rem", fontWeight: 600, padding: "0.5rem 0", borderBottom: "1px solid var(--glass-border)", color: "var(--foreground)", display: "flex", alignItems: "center", gap: "8px", background: "none", border: "none", width: "100%", textAlign: "left", cursor: "pointer" }}
          >
            📖 Special Ed & Chapter 60 Glossary
          </button>
          <button
            type="button"
          ...
          <a href="/posts" onClick={(e) => handleLinkClick(e, "/posts")} style={{ fontSize: "1rem", fontWeight: 600, padding: "0.5rem 0", borderBottom: "1px solid var(--glass-border)", color: "var(--foreground)", display: "flex", alignItems: "center", gap: "8px" }}>
            📰 Articles
          </a>
          <a href="/downloads" onClick={(e) => handleLinkClick(e, "/downloads")} style={{ fontSize: "1rem", fontWeight: 600, padding: "0.5rem 0", borderBottom: "1px solid var(--glass-border)", color: "var(--foreground)", display: "flex", alignItems: "center", gap: "8px" }}>
            📥 Downloads
          </a>
          <a href="/tutorials" onClick={(e) => handleLinkClick(e, "/tutorials")} style={{ fontSize: "1rem", fontWeight: 600, padding: "0.5rem 0", borderBottom: "1px solid var(--glass-border)", color: "var(--foreground)", display: "flex", alignItems: "center", gap: "8px" }}>
            📖 App Help
          </a>
          <a href="/videos" onClick={(e) => handleLinkClick(e, "/videos")} style={{ fontSize: "1rem", fontWeight: 600, padding: "0.5rem 0", borderBottom: "1px solid var(--glass-border)", color: "var(--foreground)", display: "flex", alignItems: "center", gap: "8px" }}>
            🎥 Videos
          </a>
      ...
      <VaultModal
        ...
        handleMoveInsightProfile={handleMoveInsightProfile}
        handleCopyVaultInsight={handleCopyVaultInsight}
        copiedInsightId={copiedInsightId}
        handleDeleteVaultInsight={handleDeleteVaultInsight}
        renderTextWithEmailBreaks={renderTextWithEmailBreaks}
      />
      ...
      {/* IEP Meeting Prep Checklist Modal */}
      {showChecklistModal && (
        <div
          style={{
      ...
      {/* Special Ed & Chapter 60 Glossary Modal */}
      {showGlossaryModal && (
